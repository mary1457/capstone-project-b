...
public interface CentroEsteticoRepository extends JpaRepository<CentroEstetico, UUID> {
    ...
    @Query("SELECT new mariapiabaldoin.capstone_project_b.payloads.CentroEsteticoUpdateDTO( " +
    ...
    CentroEsteticoUpdateDTO findCentroEsteticoUpadateDTOById(@Param("id") UUID id);
